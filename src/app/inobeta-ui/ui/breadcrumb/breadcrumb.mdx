...
<Meta title="Components/Breadcrumbs (**Deprecated**)/Overview" />

# Breadcrumbs (**Deprecated**)

> ⚠️ Breadcrumbs are deprecated and planned for removal in v21. Keep using this page only when maintaining an existing integration.
