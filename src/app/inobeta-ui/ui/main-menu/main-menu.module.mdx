...
<Meta title="Components/Main Menu (**Deprecated**)/Overview" />

# Main Menu (**Deprecated**)

> ⚠️ Main Menu is deprecated and planned for removal in v21. Keep using this page only when maintaining an existing integration.
...
export class IbMainMenuExampleComponent {
  ...
  // declare data for bottom left button
  ...
  exampleNavBottomRight: string = "© Example";
