...
.ib-table__container {
  ...
  /** Whether show a vertical outline for each column (Es. `1px`) */
...
Server-side interactions are only available with an instance of `IbTableRemoteDataSource` used as input.
