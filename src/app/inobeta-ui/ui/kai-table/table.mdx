...
:host {
  ...
  --ib-table-header-text-color: mat.get-theme-color($theme, primary, darker-contrast);
  /** Header text color. Defaults to the brand primary color */
  --ib-table-header-background-color: mat.get-theme-color($theme, primary, 500);

  /** Text color for even rows. Defaults to the relative contrast from the background color */
  --ib-table-even-row-text-color: mat.get-theme-color($theme, accent, darker-contrast);
  /** Background color for even rows. Defaults to the lightest color from the accent palette */
  --ib-table-even-row-background-color: mat.get-theme-color($theme, accent, 50);
