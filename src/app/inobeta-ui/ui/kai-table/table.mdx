...
1. Define a service that implements `IbTableDataProvider`

[sort](https://material.angular.io/components/sort/api#MatSort)
[paginator](https://material.angular.io/components/paginator/api#MatPaginator)
...
2. Instance an `IbTableRemoteDataSource`, and provide your service.

```typescript
@Component({ /** ... */ })
export class RemoveDataExample {
  private productService = inject(ProductService);
  dataSource = new IbTableRemoteDataSource(this.productService);
}
```
