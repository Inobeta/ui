...
- Authentication interceptor
  - Sets the `Authentication` header of every HTTP requests
- Error interceptor
...
To know more how to customize the module's behaviour, head over to the [API page](/docs/features-http-api--docs#injection-tokens)
...
By default, the content will be replaced for any HTTP request currently in progress.  
